...
| D24 | All repository content is in English (`AGENTS.md` rule 2) | A short Dutch preamble at the very top of the root `README.md` | Written for the target audience (municipal civil servants and CISOs), who need a friendly front door before the English technical documentation | active | `AGENTS.md` rule 2 exception, #44 |
